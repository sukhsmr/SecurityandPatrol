...
export default function Footer() {
  return (
          ...
          <div className="elementor-widget-wrap elementor-element-populated">
            <div className="elementor-element elementor-element-0fabd1b elementor-widget elementor-widget-heading" data-id="0fabd1b" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
              <div className="elementor-widget-container">
                <h2 className="elementor-heading-title elementor-size-default">24/7 Security Guard
                  Services</h2>
              </div>
            </div>
            <div className="elementor-element elementor-element-9a12861 elementor-widget elementor-widget-text-editor" data-id="9a12861" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
              <div className="elementor-widget-container">
                <p>Professional Security Guard Services Available 24/7. Request Your Free Quote
                  Today.</p>
              </div>
            </div>
    ...
    <section className="elementor-section elementor-top-section elementor-element elementor-element-d284126 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="d284126" data-element_type="section" data-e-type="section">
      <div className="elementor-container elementor-column-gap-default">
        <div className="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-a6aff7d" data-id="a6aff7d" data-element_type="column" data-e-type="column">
          <div className="elementor-widget-wrap elementor-element-populated">
            <div className="elementor-element elementor-element-1d3dc80 elementor-widget elementor-widget-heading" data-id="1d3dc80" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
              <div className="elementor-widget-container">
                <h2 className="elementor-heading-title elementor-size-default">POPULAR SEARCHES</h2>
              </div>
            </div>
            <div className="elementor-element elementor-element-5dc6a38 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="5dc6a38" data-element_type="widget" data-e-type="widget" data-widget_type="icon-list.default">
              <div className="elementor-widget-container">
                <ul className="elementor-icon-list-items">
                  <li className="elementor-icon-list-item">
                    <a href="/unarmed-security"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Unarmed Security Guard
                        Services</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/armed-security"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Armed Security Guard
                        Services</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/construction-site-security"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Construction Guard
                        Services</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/mobile-patrol-security"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Mobile Patrol Guard
                        Services</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/event-security"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Event Security Guard
                        Services</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/commercial-security"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Commercial Security Guard
                        Services</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/residential-security"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Residential Security Guard
                        Services</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/shopping-center-security-guards"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Shopping center &amp; malls,
                        Warehouse wholesale clubs</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/office-buildings"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Office buildings, High rise,
                        Parking lots</span>
                    </a>
                  </li>
                </ul>
        ...
        <div className="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-38d21da" data-id="38d21da" data-element_type="column" data-e-type="column">
          <div className="elementor-widget-wrap elementor-element-populated">
            <div className="elementor-element elementor-element-93ba32b elementor-widget elementor-widget-heading" data-id="93ba32b" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
              <div className="elementor-widget-container">
                <h2 className="elementor-heading-title elementor-size-default">POPULAR AREAS</h2>
              </div>
            </div>
            <div className="elementor-element elementor-element-2d9e962 elementor-align-start elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="2d9e962" data-element_type="widget" data-e-type="widget" data-widget_type="icon-list.default">
              <div className="elementor-widget-container">
                <ul className="elementor-icon-list-items">
                  <li className="elementor-icon-list-item">
                    <a href="/offices#California"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Security Guard Services in
                        California</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/offices#portland"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Security Guard Services in
                  ...
                  <li className="elementor-icon-list-item">
                    <a href="/offices#seattle"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Security Guard Services in
                  ...
                  <li className="elementor-icon-list-item">
                    <a href="/offices#san"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Security Guard Services in San
                        Antonio Texas</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/offices#vanc"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Security Guard Services in
                        Vancouver Washington</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/offices#Texas"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Security Guard Services in
                        Houston Texas</span>
                    </a>
        ...
        <div className="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-4039919" data-id={4039919} data-element_type="column" data-e-type="column">
          <div className="elementor-widget-wrap elementor-element-populated">
            <div className="elementor-element elementor-element-00744c4 elementor-widget elementor-widget-heading" data-id="00744c4" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
              <div className="elementor-widget-container">
                <h2 className="elementor-heading-title elementor-size-default">TRENDING SEARCHES</h2>
              </div>
            </div>
            <div className="elementor-element elementor-element-f71447f elementor-align-start elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="f71447f" data-element_type="widget" data-e-type="widget" data-widget_type="icon-list.default">
              <div className="elementor-widget-container">
                <ul className="elementor-icon-list-items">
                  <li className="elementor-icon-list-item">
                    <a href="/why-you-need-security-for-your-luxury-yacht"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Why You Need Security for Your
                        Luxury Yacht</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                    <a href="/why-you-need-residential-security"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
                      <span className="elementor-icon-list-text">Why you Need Residential
                        Security</span>
                    </a>
                  </li>
                  <li className="elementor-icon-list-item">
                  ...
                  <li className="elementor-icon-list-item">
                    <a href="/about-security-guard-jobs"><span className="elementor-icon-list-icon">
                        <i aria-hidden="true" className="icon icon-right-arrow" /> </span>
          ...
          <div className="elementor-widget-wrap elementor-element-populated">
            ...
            <div className="elementor-element elementor-element-5bc861c elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="5bc861c" data-element_type="widget" data-e-type="widget" data-widget_type="icon-list.default">
              <div className="elementor-widget-container">
                <ul className="elementor-icon-list-items">
                  <li className="elementor-icon-list-item">
                    <span className="elementor-icon-list-text">Hospital Security Guards </span>
                  </li>
                  <li className="elementor-icon-list-item">
                    <span className="elementor-icon-list-text">Retail Security Guards </span>
                  </li>
                  <li className="elementor-icon-list-item">
                    <span className="elementor-icon-list-text">Hotel Security Guards </span>
                  </li>
                  <li className="elementor-icon-list-item">
                    <span className="elementor-icon-list-text">Customized Security</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="elementor-column elementor-col-25 elementor-top-column elementor-element elementor-element-fdcc965" data-id="fdcc965" data-element_type="column" data-e-type="column">
          <div className="elementor-widget-wrap elementor-element-populated">
            ...
            <div className="elementor-element elementor-element-470fef3 elementor-widget elementor-widget-heading" data-id="470fef3" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
              <div className="elementor-widget-container">
                <h2 className="elementor-heading-title elementor-size-default">CORPORATE OFFICE</h2>
              </div>
            </div>
            <div className="elementor-element elementor-element-82ecd9e elementor-widget elementor-widget-text-editor" data-id="82ecd9e" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
              <div className="elementor-widget-container">
                <p><span style={{color: '#ffffff'}}><a style={{color: '#ffffff'}} href="/offices#California">California (Bay
                      Area)</a></span><br /><span style={{color: '#ffffff'}}><a style={{color: '#ffffff'}} href="/offices#portland">Portland</a></span><br /><span style={{color: '#ffffff'}}><a style={{color: '#ffffff'}} href="/offices#seattle">Seattle,
                      WA</a></span><br /><span style={{color: '#ffffff'}}><a style={{color: '#ffffff'}} href="/offices#vanc">Vancouver,
                      WA</a></span><br />Houston<a style={{color: 'rgb(255, 255, 255)'}} href="/offices#Texas">, TX</a><br /><span style={{color: '#ffffff'}}><a className="elementor-item elementor-item-anchor" style={{color: '#ffffff'}} href="/offices#san" aria-current="page">San Antonio</a></span></p>
              </div>
            </div>
          </div>
        </div>
        <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-a69f8e0" data-id="a69f8e0" data-element_type="column" data-e-type="column">
          <div className="elementor-widget-wrap elementor-element-populated">
            <div className="elementor-element elementor-element-36d4050 elementor-widget elementor-widget-heading" data-id="36d4050" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
              <div className="elementor-widget-container">
                <h2 className="elementor-heading-title elementor-size-default">SUBSCRIBE TO OUR
                  NEWSLETTER <br />FOR EVERY NEW NOTIFICATION</h2>
              </div>
            </div>
